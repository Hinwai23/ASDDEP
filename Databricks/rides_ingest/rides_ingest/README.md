...
This folder defines all source code for the 'rides_ingest' pipeline:
...
* Take a look at the sample under "sample_users_rides_ingest.py" to get familiar with the syntax.
